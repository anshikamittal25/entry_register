                              ...
                              onPressed: (){
                                if(_formKey.currentState.validate()){
                                  if(placePin != null) {
                                    ...
                                    places.doc(placeName.trim().toLowerCase())
                                        .set({
                                      'pin': placePin,
                                    }).then((value) => registerStatus(context, "Your place has been successfully registered."))
                                        .catchError((error) => registerStatus(context, "An error occurred."));
